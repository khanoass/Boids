...
{	
	...
	_txt_valueInfo.setCharacterSize(UINT_SLIDER_TEXT_CHARACTER_SIZE);
	_txt_valueInfo.setString("TESTSTRING");
	_txt_valueInfo.setPosition(10 + flt_length + v2f_position.x + FLT_SLIDER_TEXT_INFO_PADDING, v2f_position.y + ( V2F_SLIDER_BARS_SIZE.y - _txt_valueInfo.getGlobalBounds().height) / 2);
